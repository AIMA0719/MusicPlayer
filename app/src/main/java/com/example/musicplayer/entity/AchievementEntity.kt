...
enum class Achievement(
    ...
    val maxProgress: Int,
    val icon: String, // 이모지
    val isHidden: Boolean = false // 히든 도전과제 여부
) {
    // === 기본 도전과제 ===
    ...
    CONSECUTIVE_30_DAYS("CONSECUTIVE_30_DAYS", "한 달 챌린저", "30일 연속으로 녹음하세요", 30, "🎖️"),

    // === 점수 도전과제 ===
    SCORE_90_5_SONGS("SCORE_90_5_SONGS", "고득점 마스터", "90점 이상을 5곡 달성하세요", 5, "⭐"),
    SCORE_95_3_SONGS("SCORE_95_3_SONGS", "완벽주의자", "95점 이상을 3곡 달성하세요", 3, "💯"),
    PERFECT_SCORE("PERFECT_SCORE", "완벽한 점수", "100점을 달성하세요", 1, "👑"),
    CONSISTENCY_MASTER("CONSISTENCY_MASTER", "안정적인 실력", "10곡 연속 80점 이상", 10, "📈"),
    ...
    MORNING_BIRD("MORNING_BIRD", "아침 새", "오전 6시~9시에 녹음", 1, "🌅"),
    NIGHT_OWL("NIGHT_OWL", "올빼미", "자정~새벽 3시에 녹음", 1, "🦉"),
    ...
    RECORDING_500("RECORDING_500", "전설의 가수", "총 500곡을 녹음하세요", 500, "🌟"),
    ...
    MIDNIGHT_SINGER("MIDNIGHT_SINGER", "자정의 가수", "정확히 자정(00:00)에 녹음 시작", 1, "🌙", true),
    EARLY_BIRD("EARLY_BIRD", "새벽 기상", "새벽 5시~6시에 녹음", 1, "🌄", true),
    LUNCH_TIME_SINGER("LUNCH_TIME_SINGER", "점심시간 가수", "점심시간(12~13시)에 5곡 녹음", 5, "🍱", true),
    TIME_TRAVELER("TIME_TRAVELER", "시간 여행자", "새벽/아침/점심/저녁/밤 모두 녹음", 5, "⏰", true),
    TRIPLE_CROWN("TRIPLE_CROWN", "트리플 크라운", "3곡 연속 95점 이상", 3, "🎩", true),
    SPEED_DEMON("SPEED_DEMON", "스피드 러너", "1시간 내 5곡 녹음", 5, "⚡", true),
    MARATHON_SINGER("MARATHON_SINGER", "마라톤 가수", "하루에 20곡 녹음", 20, "🏃", true),
    DIVERSITY_MASTER("DIVERSITY_MASTER", "다양성의 달인", "서로 다른 10곡 녹음", 10, "🌈", true),
    COMEBACK("COMEBACK", "재기의 달인", "40점대 이후 90점 이상 달성", 1, "💪", true),
    WEEKEND_WARRIOR("WEEKEND_WARRIOR", "주말 전사", "주말에만 10곡 녹음", 10, "⚔️", true),
}
