...
object ErrorHandler {
    ...
    private fun handleGenericException(context: Context, exception: Throwable) {
        ...
        ToastManager.getInstance().show("예기치 않은 오류가 발생했습니다: ${exception.message}")
    }
} 